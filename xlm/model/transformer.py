...
class TransformerModel(nn.Module):
    ...
    def generate(self, src_enc, src_len, tgt_lang_id, max_len=200, sample_temperature=None, return_outputs=False):
        """
        ...
        while cur_len < max_len:
            ...
            tensor = self.forward(
                'fwd',
                x=generated[:cur_len].detach().clone(),
                lengths=gen_len,
        ...
        if return_outputs:
            return generated[:cur_len], gen_len, dec
        else:
