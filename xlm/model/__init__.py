...
def build_language_discriminator(params):
    language_discriminator = MLP(nin=params.emb_dim, nout=2, nh=params.emb_dim, 
                                 n_layers=params.n_layer_dis, dropout=params.dropout_dis)
    return language_discriminator.cuda()
